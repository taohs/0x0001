...
<div class="right">
    <div class="body" style="margin-top: 0px;">
        ...
        <div class="addlist">
            <?php if($model->isAttributeRequired('oldPassword')){?>
            <ul class="clear">
                <li class="a1"><span>※</span><b>旧密码</b></li>
                <li class="a2">
                    <?php echo $form->passwordField($model,'oldPassword',array('class'=>'text','style'=>'width:180px','autoComplete'=>'off')); ?>
            ...
            <ul class="clear">
                ...
                <li class="a2">
                    <?php echo $form->passwordField($model,'newPassword',array('class'=>'text','style'=>'width:180px','autoComplete'=>'off')); ?>
            ...
            <ul class="clear">
                ...
                <li class="a2">
                    <div>
                    <?php echo $form->passwordField($model,'rePassword',array('class'=>'text','style'=>'width:180px','autoComplete'=>'off')); ?>
