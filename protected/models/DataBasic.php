...
/**
 * This is the model class for table "tb_back_data_basic".
 *
 * The followings are the available columns in table 'tb_back_data_basic':
 * @property integer $id
 ...
 */
class DataBasic extends CActiveRecord
{
	/**
	 ...
	 * @return DataBasic the static model class
	 */
