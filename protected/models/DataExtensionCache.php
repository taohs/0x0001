...
/**
 * This is the model class for table "tb_back_data_extension_cache".
 *
 * The followings are the available columns in table 'tb_back_data_extension_cache':
 * @property integer $id
 ...
 */
class DataExtensionCache extends CActiveRecord
{
	/**
	...
	{
		return 'tb_back_data_extension_cache';
	}
	 ...
	 * @return DataExtensionCache the static model class
	 */
